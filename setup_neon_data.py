...
def setup_sample_data():
    print("🚀 ProjectOps Assistant - Data Setup")
    print("This will add sample project data to your Neon database.")
    ...
    try:
        ...
        for project in sample_projects:
            ...
            if success:
                ...
                print(f"❌ Failed to add project: {project['project_name']}")
        ...
        for meeting in sample_meetings:
            ...
            if success:
                print(f"✅ Added meeting for project {meeting['project_id']}")
            else:
                print(f"❌ Failed to add meeting for project {meeting['project_id']}")
        ...
        for update in sample_updates:
            ...
            if success:
                print(f"✅ Added client update for project {update['project_id']}")
            else:
                print(f"❌ Failed to add client update for project {update['project_id']}")
        ...
        for issue in sample_issues:
            ...
            if success:
                print(f"✅ Added issue for project {issue['project_id']}")
            else:
                print(f"❌ Failed to add issue for project {issue['project_id']}")
        
        print("\n🎉 Sample data setup completed successfully!")
        print("You can now view your projects, meetings, updates, and issues in the main app.")
        
    except Exception as e:
        print(f"❌ Setup failed: {e}")
        print("Make sure your Neon database is properly configured in Streamlit Cloud secrets.")
